...
<body id="body">
    ...
    <header>
        ...
        <div class="titulo">
            <h3>MODULO PARA AGREGAR PACIENTES A LA BASE DE DATOS</h3>
        </div>
    </header>
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">	
            ...
            <a href="RegistrarPaciente.php" class="selected">
                <div class="option">
    ...
    <div class="contenedor_login_registrar">
        ...
        <form action="php/registrar_paciente.php" method="POST" class="formulario_registrar_profesional">
